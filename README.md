...
| #   | System                                   | What It Covers                                                                   | Category                     | Complexity | Link                                                                         |
| --- | ---------------------------------------- | -------------------------------------------------------------------------------- | ---------------------------- | ---------- | ---------------------------------------------------------------------------- |
| 1   | E-Commerce Platform                      | Product catalog, shopping cart, checkout, and order management                   | Commerce Platform            | High       | [Link](./Larger%20System/01_e-Commerce%20Platform/02-System-Architecture.md) |
...
| 8   | E-Wallet Platform                        | Wallet balances, top-ups, transfers, and transaction records                     | FinTech                      | High       | Pending                                                                      |
